...
use ARPC\Popup\Ajax;
use ARPC\Popup\ARPC_Setup_Wizard;
use ARPC\Popup\Assets;
use ARPC\Popup\Frontend;
use ARPC\Popup\Installer;
use ARPC\Popup\Settings_API\Hub_Settings_API_Test;
...
add_action( 'wp_loaded', function () {
    $setup_wizard = get_option( 'arpc_setup_wizard' );

    if ( $setup_wizard == 'init' ) {
        new ARPC_Setup_Wizard();
    }
} );