...
class Menu {
      ...
      public function settings_page() {
            ...
            <div class="wrap arpc_add_contact_wrap">
                  ...
                  <form method="post" action="" class="arpc_metabox_wrapper">
                        ...
                        <input type="submit" class="button button-primary" name="arpc_submit_form" value="<?php esc_attr_e( 'Add Address' ); ?>" />
                  </form>
            </div>
